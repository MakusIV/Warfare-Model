...
class Ship_Data:
    ...
    def __init__(
        ...
        self.users = users or []    # paesi che hanno realmente in uso/hanno usato il modello
...
FFG46_data = {
    ...
    'model':         'FFG-46',
    'made':          'USA',
    'users':         ['USA', 'Australia', 'Bahrain', 'Egypt', 'Poland', 'Spain', 'Taiwan', 'Turkey'],
...
FFL1124_data = {
    ...
    'made':          'Russia',
    'users':         ['Russia', 'Ukraine', 'Lithuania'],
...
FSG1241_data = {
    ...
    'made':          'Russia',
    'users':         ['Russia', 'India', 'Poland', 'Vietnam', 'Bulgaria', 'Yemen', 'Turkmenistan'],
