...
from Code.Dynamic_War_Manager.Source.Asset.Ground_Weapon_Data import get_weapon_score, get_weapon_score_target, get_weapon_score_target_distribuition
...
#SPEED_REFERENCE_KMH = 100.0  # km/h: riferimento per la normalizzazione dello speed score; nessun veicolo da combattimento terrestre supera questo valore su strada
...
class Vehicle_Data:
    ...
    def __init__(self, constructor: str, made: str, model: str, category: str, physical_characteristics: Dict, start_service: str, end_service: str, cost: int, range: int, roles: str, engine: Dict, weapons: Dict, radar: Dict, TVD: Dict, communication: Dict, hydraulic: Dict, protections: Dict, speed_data: Dict, users: Optional[List[str]] = None):
        ...
        self.users = users or [] # paesi che hanno in uso/hanno usato il modello (storico e/o attuale); mai None
    ...
    def _radar_eval(self, modes: Optional[List] = None) -> float:
        ...
        reference_values = {
            'tracking_range': 100.0, # km
            'acquisition_range': 150.0, # km
            'engagement_range': 80.0, # km
            'multi_target_capacity': 3 # number of targets
        }
    ...
    def _TVD_eval(self, modes: Optional[List] = None) -> float:
        ...
        reference_values = {
            'tracking_range': 10.0, # km
            'acquisition_range': 15.0, # km
            'engagement_range': 8.0, # km
            'multi_target_capacity': 1 # number of targets
        }
    ...
    def _speed_eval(self):
        ...
        Returns:
            float: Normalized speed score in [0, 1] relative to reference_value = 100 km/h.
        Raises:
        ...
        reference_value = 100 # km/h, riferimento per la normalizzazione dello speed score; nessun veicolo da combattimento terrestre supera questo valore su strada
        ...
        return (score / sum(weights.values())) / reference_value
    ...
    def _weapon_eval(self):
        ...
        for weapon_type, weapon in self.weapons.items():      
            ...
            for weapon_item in weapon:                
                ...
                if weapon_type == 'CANNONS' or weapon_type == 'ARTILLERY':                    
                    if self.category in [Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value, Ground_Vehicle_Asset_Type.TANK.value, Ground_Vehicle_Asset_Type.ARMORED.value]:
        ...
        return score # riduco il peso delle mitragliatrici al 33% dello score totale in quanto armi di supporto se presente score (arma principale)
    ...
    def _combat_eval(self):        
        ...
        params = {   
                    ...
                    'radar':            { 'score': self._radar_eval(), 
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 1, 
                                                      Ground_Vehicle_Asset_Type.ARMORED.value: 1,
                                                      Ground_Vehicle_Asset_Type.MOTORIZED.value: 1,
                                                      ...
                                                      Ground_Vehicle_Asset_Type.SAM_SMALL.value: 3,
                    ...
                    'TVD':              { 'score': self._TVD_eval(),
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 3, 
                                                      ...
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value: 1,
                                                      Ground_Vehicle_Asset_Type.SAM_BIG.value: 3,
                                                      Ground_Vehicle_Asset_Type.SAM_MEDIUM.value: 3,
                                                      Ground_Vehicle_Asset_Type.SAM_SMALL.value: 3,
                                                      Ground_Vehicle_Asset_Type.EWR.value: 1,
                    ...
                    'protection':       { 'score': self._protection_eval(), 
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 10, 
                                                      Ground_Vehicle_Asset_Type.ARMORED.value: 10,
                                                      Ground_Vehicle_Asset_Type.MOTORIZED.value: 5,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_FIXED.value: 2,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value: 10,
                    ...
                    'communication':    { 'score': self._communication_eval(), 
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 1, 
                                                      ...
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_FIXED.value: 1,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value: 1,
                                                      Ground_Vehicle_Asset_Type.SAM_BIG.value: 1,
                                                      Ground_Vehicle_Asset_Type.SAM_MEDIUM.value: 1,
                                                      Ground_Vehicle_Asset_Type.SAM_SMALL.value: 1,
                                                      Ground_Vehicle_Asset_Type.EWR.value: 1,
                                                      Ground_Vehicle_Asset_Type.AAA.value: 1
                                                      } }, 
                    'speed_data':       { 'score': self._speed_eval(),
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 5, 
                                                      Ground_Vehicle_Asset_Type.ARMORED.value: 5,
                                                      Ground_Vehicle_Asset_Type.MOTORIZED.value: 5,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_FIXED.value: 1,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value: 5,
                                                      Ground_Vehicle_Asset_Type.SAM_BIG.value: 2,
                                                      Ground_Vehicle_Asset_Type.SAM_MEDIUM.value: 2,
                                                      Ground_Vehicle_Asset_Type.SAM_SMALL.value: 2,
                                                      Ground_Vehicle_Asset_Type.EWR.value: 1,
                    ...
                    'range':            { 'score': self._range_eval(), 
                                          'weights': {Ground_Vehicle_Asset_Type.TANK.value: 5, 
                                                      Ground_Vehicle_Asset_Type.ARMORED.value: 5,
                                                      Ground_Vehicle_Asset_Type.MOTORIZED.value: 5,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_FIXED.value: 5,
                                                      Ground_Vehicle_Asset_Type.ARTILLERY_SEMOVENT.value: 5,
                                                      Ground_Vehicle_Asset_Type.SAM_BIG.value: 5,
    ...
    def _weapon_target_effectiveness_distribuition(self, target_type: Dict, target_dimension: Dict) -> float:
        """Returns the weapon effectiveness score against specific target types and dimensions.
        ...
        Args:
            target_type (Dict): target type strings, e.g. {'Soft': 1.0}, {'Armored': 0.4, 'Soft': 0.6}
            target_dimension (Dict): target size strings, e.g. {'big': 1.0}, {'med': 0.3, 'small': 0.7}
        ...
        for weapon_type, weapon in self.weapons.items():
            ...
            for weapon_item in weapon:
                ...
                factor_ammo_quantity = max(0.80, min(1.2, factor_ammo_quantity))
                score += get_weapon_score_target_distribuition(weapon_item[0], target_type, target_dimension) * factor_ammo_quantity
    ...
    def get_normalized_weapon_target_effectiveness_distribuition(self, target_type: Dict, target_dimension: Dict, category: Optional[str] = None) -> float:
        ...
        Args:
            target_type (Dict): target type strings with weights, e.g. {'Soft': 1.0}, {'Armored': 0.7, 'Soft': 0.3}
            target_dimension (Dict): target size strings with weights, e.g. {'big': 1.0}, {'med': 0.6, 'small': 0.4}
...
T72_data = {
    ...
    'model': 'T-72B',
    'made': 'Russia',
    'users': ['Russia', 'Belarus', 'Syria', 'Algeria', 'Azerbaijan'],
    'start_service': 2020,
    'end_service': None,
    'category': 'Tank', # Main Battle Tank
...
BMP1_data = {
    ...
    'model': 'BMP-1',
    'made': 'Russia',
    'users': ['USSR', 'Russia', 'India', 'Syria', 'Egypt', 'Iraq', 'Poland', 'Vietnam'],
    'start_service': 1966,
    'end_service': None,
    'category': 'Armored', # 
...
T55_data = {
    ...
    'model': 'T-55',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Vietnam', 'Syria', 'Egypt', 'North Korea', 'Cuba', 'Iraq', 'Yemen'],
    'start_service': 1958,
    'end_service': 1990,
    'category': 'Tank',
...
Chieftain_MK3_data = {
    ...
    'model': 'Chieftain-MK3',
    'made': 'UK',
    'users': ['UK', 'Iran', 'Kuwait', 'Oman', 'Jordan'],
    'start_service': 1969,
    'end_service': 1995,
    'category': 'Tank',
...
Leopard_1A3_data = {
    ...
    'model': 'Leopard-1A3',
    'made': 'Germany',
    'users': ['Germany', 'Netherlands', 'Belgium', 'Italy', 'Norway', 'Denmark', 'Greece', 'Turkey', 'Canada', 'Australia', 'Brazil', 'Chile'],
    'start_service': 1973,
    'end_service': 2000,
    'category': 'Tank',
...
M60A3_data = {
    ...
    'model': 'M60A3-Patton',
    'made': 'USA',
    'users': ['USA', 'Egypt', 'Saudi Arabia', 'Turkey', 'Greece', 'Thailand', 'Taiwan', 'Israel', 'Jordan'],
    'start_service': 1978,
    'end_service': 1997,
    'category': 'Tank',
...
Leopard_2A4_data = {
    ...
    'model': 'Leopard-2A4',
    'made': 'Germany',
    'users': ['Germany', 'Turkey', 'Greece', 'Austria', 'Spain', 'Switzerland', 'Finland', 'Poland', 'Chile', 'Indonesia'],
    'start_service': 1985,
    'end_service': None,
    'category': 'Tank',
...
Leopard_2A5_data = {
    ...
    'model': 'Leopard-2A5',
    'made': 'Germany',
    'users': ['Germany', 'Sweden', 'Poland', 'Netherlands', 'Spain', 'Denmark'],
    'start_service': 1995,
    'end_service': None,
    'category': 'Tank',
...
Leopard_2A6M_data = {
    ...
    'model': 'Leopard-2A6M',
    'made': 'Germany',
    'users': ['Germany', 'Canada', 'Netherlands', 'Portugal', 'Singapore', 'Ukraine'],
    'start_service': 2007,
    'end_service': None,
    'category': 'Tank',
...
M1A2_Abrams_data = {
    ...
    'model': 'M1A2-Abrams',
    'made': 'USA',
    'users': ['USA', 'Saudi Arabia', 'Kuwait', 'Egypt', 'Iraq', 'Australia', 'Poland', 'Taiwan'],
    'start_service': 1992,
    'end_service': None,
    'category': 'Tank',
...
Type_59_data = {
    ...
    'model': 'Type-59',
    'made': 'China',
    'users': ['China', 'Pakistan', 'North Korea', 'Vietnam', 'Albania', 'Iraq', 'Bangladesh', 'Sudan', 'Tanzania'],
    'start_service': 1958,
    'end_service': 1985,
    'category': 'Tank',
...
T80U_data = {
    ...
    'model': 'T-80U',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'South Korea', 'Cyprus'],
    'start_service': 1985,
    'end_service': None,
    'category': 'Tank',
...
T90_base_data = {
    ...
    'model': 'T-90',
    'made': 'Russia',
    'users': ['Russia', 'India', 'Algeria', 'Turkmenistan', 'Azerbaijan', 'Vietnam'],
    'start_service': 1992,
    'end_service': None,
    'category': 'Tank',
...
T72B3_data = {
    ...
    'model': 'T-72B3',
    'made': 'Russia',
    'users': ['Russia', 'Laos', 'Nicaragua', 'Uganda'],
    'start_service': 2013,
    'end_service': None,
    'category': 'Tank',
...
BMP2_data = {
    ...
    'model': 'BMP-2',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'India', 'Syria', 'Iraq', 'Sri Lanka', 'Angola', 'Finland'],
    'start_service': 1980,
    'end_service': None,
    'category': 'Armored',
...
BMD1_data = {
    ...
    'model': 'BMD-1',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Belarus', 'India', 'Angola', 'Iraq'],
    'start_service': 1969,
    'end_service': None,
    'category': 'Armored',
...
M2_Bradley_data = {
    ...
    'model': 'M2-Bradley',
    'made': 'USA',
    'users': ['USA', 'Saudi Arabia', 'Ukraine'],
    'start_service': 1981,
    'end_service': None,
    'category': 'Armored',
    'physical_characteristics': {'length': 7, 'width': 3, 'height': 3, 'weight': 28},
...
BMP3_data = {
    ...
    'model': 'BMP-3',
    'made': 'USSR',
    'users': ['Russia', 'UAE', 'Kuwait', 'South Korea', 'Indonesia', 'Cyprus', 'Venezuela'],
    'start_service': 1987,
    'end_service': None,
    'category': 'Armored',
...
BTR82A_data = {
    ...
    'model': 'BTR-82A',
    'made': 'Russia',
    'users': ['Russia', 'Kazakhstan', 'Belarus', 'Azerbaijan', 'Syria', 'Venezuela'],
    'start_service': 2012,
    'end_service': None,
    'category': 'Armored',
...
SdKfz_251_data = {
    ...
    'model': 'Sd.Kfz-251',
    'made': 'Germany',
    'users': ['Germany', 'Czechoslovakia', 'Israel', 'Syria', 'Spain', 'Portugal'],
    'start_service': 1939,
    'end_service': 1945,
    'category': 'Armored',
...
MTLB_data = {
    ...
    'model': 'MT-LB',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Belarus', 'Iraq', 'Finland', 'Vietnam', 'India'],
    'start_service': 1966,
    'end_service': None,
    'category': 'Armored',
...
M113_data = {
    ...
    'model': 'M-113',
    'made': 'USA',
    'users': ['USA', 'Italy', 'Israel', 'South Korea', 'Australia', 'Canada', 'Vietnam', 'Iran', 'Saudi Arabia'],
    'start_service': 1960,
    'end_service': None,
    'category': 'Armored',
...
AAV7_data = {
    ...
    'model': 'AAV7',
    'made': 'USA',
    'users': ['USA', 'South Korea', 'Japan', 'Italy', 'Spain', 'Brazil', 'Thailand', 'Argentina'],
    'start_service': 1972,
    'end_service': None,
    'category': 'Armored',
...
TPz_Fuchs_data = {
    ...
    'model': 'TPz-Fuchs',
    'made': 'Germany',
    'users': ['Germany', 'Netherlands', 'Saudi Arabia', 'Kuwait', 'Venezuela', 'Israel'],
    'start_service': 1979,
    'end_service': None,
    'category': 'Armored',
...
BTR80_data = {
    ...
    'model': 'BTR-80',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Kazakhstan', 'India', 'Iraq', 'Turkmenistan'],
    'start_service': 1986,
    'end_service': None,
    'category': 'Armored',
...
BTR_RD_data = {
    ...
    'model': 'BTR-RD',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Belarus', 'Ukraine'],
    'start_service': 1984,
    'end_service': None,
    'category': 'Armored',
    'physical_characteristics': {'length': 6, 'width': 3, 'height': 2, 'weight': 8},
...
BM21_Grad_data = {
    ...
    'model': 'BM-21-Grad',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Syria', 'Vietnam', 'Angola', 'Iraq', 'Cuba', 'Ukraine'],
    'start_service': 1963,
    'end_service': None,
...
S2S3_Akatsia_data = {
    ...
    'model': '2S3-Akatsia',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Syria', 'Libya', 'Angola', 'Iraq'],
    'start_service': 1971,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
S2S1_Gvozdika_data = {
    ...
    'model': '2S1-Gvozdika',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Poland', 'Ukraine', 'Syria', 'Iraq', 'Finland', 'Georgia'],
    'start_service': 1972,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
BM27_Uragan_data = {
    ...
    'model': 'BM-27-Uragan',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Syria', 'Angola', 'Belarus', 'Kazakhstan'],
    'start_service': 1975,
    'end_service': None,
    'category': 'Artillery_Semovent',
    ...
    'weapons': {
        'ROCKETS': [('220mm-Uragan-Rocket', 16)],
    },
    'radar': False,
    'TVD': False,
    'communication': {
...
Dana_vz77_data = {
    ...
    'model': 'Dana-vz77',
    'made': 'Czechoslovakia',
    'users': ['Czechoslovakia', 'Czech Republic', 'Slovakia', 'Poland', 'Libya', 'Georgia', 'Azerbaijan', 'Ukraine'],
    'start_service': 1980,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
S2S9_Nona_data = {
    ...
    'model': '2S9-Nona',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'Belarus', 'Ivory Coast', 'Moldova'],
    'start_service': 1981,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
M270_MLRS_data = {
    ...
    'model': 'M270-MLRS',
    'made': 'USA',
    'users': ['USA', 'UK', 'Germany', 'France', 'Italy', 'South Korea', 'Japan', 'Bahrain', 'Ukraine'],
    'start_service': 1983,
    'end_service': None,
    'category': 'Artillery_Semovent',
    'physical_characteristics': {'length': 7, 'width': 3, 'height': 3, 'weight': 25},
...
A9A52_Smerch_data = {
    ...
    'model': '9A52-Smerch',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'India', 'Belarus', 'Ukraine', 'Algeria', 'Kuwait', 'Peru'],
    'start_service': 1989,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
S2S19_Msta_data = {
    ...
    'model': '2S19-Msta',
    'made': 'USSR',
    'users': ['Russia', 'Azerbaijan', 'Ethiopia', 'Georgia', 'Ukraine', 'Venezuela'],
    'start_service': 1989,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
M109_Paladin_data = {
    ...
    'model': 'M109-Paladin',
    'made': 'USA',
    'users': ['USA', 'Germany', 'Italy', 'Saudi Arabia', 'Israel', 'South Korea', 'Taiwan', 'Egypt'],
    'start_service': 1992,
    'end_service': None,
    'category': 'Artillery_Semovent',
...
ZSU_57_2_data = {
    ...
    'model': 'ZSU-57-2',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Egypt', 'Syria', 'Vietnam', 'North Korea', 'Cuba', 'Iraq'],
    'start_service': 1957,
    'end_service': 1990,
    'category': 'AAA',
...
ZSU_23_4_data = {
    ...
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Syria', 'Egypt', 'India', 'Poland', 'Iraq', 'Angola', 'Vietnam'],
    'start_service': 1965,
    'end_service': None,
    'category': 'AAA',
    'physical_characteristics': {'length': 7, 'width': 3, 'height': 3, 'weight': 21},
...
M163_VADS_data = {
    ...
    'model': 'M163-VADS',
    'made': 'USA',
    'users': ['USA', 'Israel', 'Morocco', 'Portugal', 'Thailand', 'Tunisia'],
    'start_service': 1969,
    'end_service': 1998,
    'category': 'AAA',
...
Flakpanzer_Gepard_data = {
    ...
    'made': 'Germany',
    'users': ['Germany', 'Netherlands', 'Belgium', 'Chile', 'Romania', 'Brazil', 'Jordan', 'Ukraine'],
    'start_service': 1976,
    'end_service': None,
    'category': 'AAA',
...
K2K22_Tunguska_data = {
    ...
    'model': '2K22-Tunguska',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'India', 'Belarus', 'Ukraine', 'Morocco', 'Myanmar'],
    'start_service': 1982,
    'end_service': None,
    'category': 'SAM_Small',
...
Strela1_9P31_data = {
    ...
    'model': 'Strela-1-9P31',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Egypt', 'Syria', 'India', 'Poland', 'Cuba', 'Vietnam', 'Libya'],
    'start_service': 1968,
    'end_service': None,
    'category': 'SAM_Small',
...
MIM72G_Chaparral_data = {
    ...
    'made': 'USA',
    'users': ['USA', 'Israel', 'Taiwan', 'Portugal', 'Morocco', 'Egypt', 'Tunisia'],
    'start_service': 1969,
    'end_service': 1998,
    'category': 'SAM_Small',
...
A9A33_Osa_data = {
    ...
    'model': '9A33-Osa',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'India', 'Greece', 'Syria', 'Poland', 'Algeria', 'Cuba'],
    'start_service': 1971,
    'end_service': None,
    'category': 'SAM_Small',
...
K9K35_Strela10_data = {
    ...
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Ukraine', 'India', 'Poland', 'Angola', 'Syria', 'Belarus'],
    'start_service': 1976,
    'end_service': None,
    'category': 'SAM_Small',
...
MIM115_Roland_data = {
    ...
    'made': 'France',
    'users': ['France', 'Germany', 'USA', 'Spain', 'Argentina', 'Iraq', 'Venezuela', 'Qatar', 'Nigeria'],
    'start_service': 1977,
    'end_service': None,
    'category': 'SAM_Small',
...
K9K331_Tor_data = {
    ...
    'model': '9K331-Tor',
    'made': 'USSR',
    'users': ['Russia', 'Greece', 'Cyprus', 'Egypt', 'Iran', 'China', 'Belarus', 'Venezuela'],
    'start_service': 1986,
    'end_service': None,
    'category': 'SAM_Small',
...
K2K12_Kub_data = {
    ...
    'model': '2K12-Kub',
    'made': 'USSR',
    'users': ['USSR', 'Russia', 'Syria', 'Egypt', 'India', 'Poland', 'Vietnam', 'Algeria', 'Iraq'],
    'start_service': 1967,
    'end_service': None,
    'category': 'SAM_Medium',
...
K9K37_Buk_data = {
    ...
    'model': '9K37-Buk',
    'made': 'USSR',
    'users': ['Russia', 'Ukraine', 'Belarus', 'Egypt', 'Syria', 'Venezuela', 'Georgia', 'Finland'],
    'start_service': 1979,
    'end_service': None,
    'category': 'SAM_Medium',
...
S300PS_data = {
    ...
    'model': 'S-300PS',
    'made': 'USSR',
    'users': ['Russia', 'Belarus', 'Slovakia', 'Bulgaria', 'Greece', 'Vietnam'],
    'start_service': 1982,
    'end_service': None,
    'category': 'SAM_Big',
