...
class AssetParams:
    ...
    acp: Optional[Payload] = None           # assigned consume payload - resourse assigned for autoconsume
    rcp: Optional[Payload] = None           # requested consume payload - resource requeste for autoxconsume
...
class Asset:
    def __init__(self, block: Block, name: Optional[str] = None, description: Optional[str] = None, 
                 ...
                 value: Optional[int] = None, acp: Optional[Payload] = None, 
                 rcp: Optional[Payload] = None, payload: Optional[Payload] = None, 
        ...
        self._acp = acp if acp else Payload(goods=0, energy=0, hr=0, hc=0, hs=0, hb=0)
        self._rcp = rcp if rcp else Payload(goods=0, energy=0, hr=0, hc=0, hs=0, hb=0)
        ...
        self._validate_all_params(
            ...
            value=value, acp=self._acp, rcp=self._rcp, payload=self._payload,
    ...
    def balance_trade(self) -> float:
        ...
        for item in ['goods', 'energy', 'hr', 'hc', 'hs', 'hb']:
            rcp_val = getattr(self.rcp, item, 0)
            if rcp_val > 0:
                acp_val = getattr(self.acp, item, 0)
    ...
    @acp.setter
    def acp(self, value: Payload) -> None:
        self._validate_param('acp', value, Payload)
        self._acp = value
    ...
    @rcp.setter
    def rcp(self, value: Payload) -> None:
        self._validate_param('rcp', value, Payload)
        self._rcp = value
