...
## Start here
- [Fase 2 (fog-of-war combat power) — 6-phase plan, ALL 7 Qs RESOLVED, Fase 1 IMPLEMENTED 2026-09-16](project_fase2_recon_combat_power_plan.md) — second Opus/high-effort pass verified everything against code (69 checks); Fase 1 (C2 observer-side fix in get_recon_reports) done, suite re-run pending; Fase 2-6 (incl. new Fase 3-bis: Aircraft physical dimension field) not yet implemented
