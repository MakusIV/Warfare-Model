...
- [Air priority: target-specific loadout selection — DESIGN READY, not implemented](project_air_priority_target_specific_loadout.md) — 2026-09-11: full design for combat_score_target_effectiveness + loadout-availability cascade (year/doctrine/stock); found+fixed 2 live bugs along the way (Military.get_military_category always "Naval_Base", TARGET_CLASSIFICATION dict_keys)
