...
## Start here
- [Fase 2 (fog-of-war combat power) — 6-phase plan, ALL 7 Qs RESOLVED, Fase 1+2 IMPLEMENTED 2026-09-16](project_fase2_recon_combat_power_plan.md) — Fase 1 (C2 observer-side fix) + Fase 2 (action-based combat power selection, Attack/max(Defense,Maintain)) done & tested (2473 OK); also fixed AAA duplicate in TARGET_CLASSIFICATION; Fase 3-bis onward not yet implemented
