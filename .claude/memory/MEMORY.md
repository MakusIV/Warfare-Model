...
- [Air priority: target-specific loadout selection — mostly done, 2026-09-14 update UNCOMMITTED](project_air_priority_target_specific_loadout.md) — items 3-7+8 committed/pushed 2026-09-12; 2026-09-14 added producer-duplication fix (shared `Context.classify_asset_dimension`) + `get_target_report` no-visibility fix, full suite 2465 OK — not yet committed; also mil_category priority-list split now implemented (uncommitted)
