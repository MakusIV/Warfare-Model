...
- [Air priority: target-specific loadout selection — checklist item 3 DONE, 4-8 open](project_air_priority_target_specific_loadout.md) — 2026-09-12: WEAPON_TARGET_CLASS_MAP (26→12) + get_weapon_score_target now raises on invalid class added, fixed latent Generic/Helibase-scores-0.0 bug, suite 2343 OK/5 skipped; still open: Region._target_profile_from_block/_profile_to_weapon_lists, best_loadout_against_target, loadout availability cascade, _target_affinity integration
