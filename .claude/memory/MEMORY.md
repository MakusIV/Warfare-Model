...
## Start here
- [Fase 2 (fog-of-war combat power) — 6-phase plan, ALL 7 Qs RESOLVED, Fase 1-4 IMPLEMENTED 2026-09-16](project_fase2_recon_combat_power_plan.md) — C2 fix, action-based combat power, real Aircraft dimensions, Combat_Power_Estimation.py module, AND real researched `users` field for all 64 Vehicle + 23 Ship models (2 parallel research agents) all done & tested (2496 OK); only Fase 5 (wiring into Region via use_recon) remains
