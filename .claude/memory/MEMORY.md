...
- [Air priority: target-specific loadout selection — COMPLETE, committed & pushed 2026-09-12](project_air_priority_target_specific_loadout.md) — items 3-7 + weighted-distribution half of item 8 all done, `_profile_to_weapon_lists` replaced by `_profile_to_weapon_distribution`; route_length/route_speed explicitly deferred indefinitely by user, do not re-raise; suite 2439 OK/5 skipped, feature fully live in real priority numbers
