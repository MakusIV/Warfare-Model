...
## Start here
- [Fase 2 (fog-of-war combat power) — 6-phase plan, ALL 7 Qs RESOLVED, Fase 1+2+3-bis+3 IMPLEMENTED 2026-09-16](project_fase2_recon_combat_power_plan.md) — C2 observer fix, action-based combat power selection, real Aircraft dimensions, AND new Combat_Power_Estimation.py calibration module all done & tested (2494 OK); module not yet wired into Region (that's Fase 5); Fase 4 (users field) onward not yet implemented
